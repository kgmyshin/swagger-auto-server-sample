...
[![Build Status](https://travis-ci.org/kgmyshin/swagger-auto-server-sample.svg?branch=master)](https://travis-ci.org/kgmyshin/swagger-auto-server-sample)
...
6. If you did everything correct, https://kgmyshin.github.io/swagger-auto-server-sample/ will lead to your new docs
...
- Documentation(ReDoc): https://kgmyshin.github.io/swagger-auto-server-sample/
- SwaggerUI: https://kgmyshin.github.io/swagger-auto-server-sample/swagger-ui/
- Look full spec:
    + JSON https://kgmyshin.github.io/swagger-auto-server-sample/swagger.json
    + YAML https://kgmyshin.github.io/swagger-auto-server-sample/swagger.yaml
- Preview spec version for branch `[branch]`: https://kgmyshin.github.io/swagger-auto-server-sample/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://kgmyshin.github.io/swagger-auto-server-sample/ with url from the message: `Server started <url>`
3. Make changes using your favorite editor or `swagger-editor` (look for URL in console output)
4. All changes are immediately propagated to your local server, moreover all documentation pages will be automagically refreshed in a browser after each change
**TIP:** you can open `swagger-editor`, documentation and `swagger-ui` in parallel
5. Once you finish with the changes you can run tests using: `npm test`
6. Share you changes with the rest of the world by pushing to GitHub :smile:
# swagger-auto-server-sample
